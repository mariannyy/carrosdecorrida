...
{
	car1Y = car1Y - 10;
	console.log("quando seta para cima é precionada,x = " + car1X +" | y =" +car1Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car1Y =car1Y+10;
	console.log("quando a seta para baixo é precionada, x= " + car1X + "| y ="+car1y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car1X - 10;
	console.log("quando a seta para a esquerda é precionada, x - " + car1X + car1X +" | y = " +car1Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car1X=car1X + 10;
	console.log("quando a seta para a direita é precionada, x - " + car1X + car1X +" | y = " +car1Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
...
{
	car1Y = car2Y - 10;
	console.log("quando tecla W é precionada,x = " + car2X +" | y =" +car2Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car1Y =car2Y+10;
	console.log("quando a tecla S é precionada, x= " + car2X + "| y ="+car2y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car2X - 10;
	console.log("quando a tecla D é precionada, x - " + car2X + car2X +" | y = " +car2Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
}
...
{
	car2X=car2X + 10;
	console.log("quando a tecla A é precionada, x - " + car2X + car2X +" | y = " +car2Y);
	uploadBackground();
	uploadcar1();
	uploadcar2();
